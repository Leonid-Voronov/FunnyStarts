...
namespace Unity.Physics.Editor
{
    ...
    class PhysicsShapeAuthoringEditor : BaseEditor
    {
        static class Styles
        {
            ...
            {
                L10n.Tr($"{k_Singular} will be considered static. Add a {ObjectNames.NicifyVariableName(typeof(PhysicsBodyAuthoringExternal).Name)} component if you will move it at run-time."),
                L10n.Tr($"{k_Plural} will be considered static. Add a {ObjectNames.NicifyVariableName(typeof(PhysicsBodyAuthoringExternal).Name)} component if you will move them at run-time.")
            };
        ...
        protected override void OnEnable()
        {
            ...
            m_NumImplicitStatic = targets.Cast<PhysicsShapeAuthoring>().Count(
                ...
                && shape.GetComponent<PhysicsBodyAuthoringExternal>() == null
