...
namespace Unity.Physics.Authoring
{
    ...
    public abstract class JointBaker<T> : Baker<T> where T : BaseJoint
    {
        ...
        public uint GetWorldIndex(Component c)
        {
            ...
            if (c)
            {
                var physicsBody = GetComponent<PhysicsBodyAuthoringExternal>(c);
                if (physicsBody != null)
                {
        ...
        {
            var physicsBody = GetComponent<PhysicsBodyAuthoringExternal>(authoring);
            ...
            var connectedBody = GetComponent<PhysicsBodyAuthoringExternal>(authoring.ConnectedBody);
